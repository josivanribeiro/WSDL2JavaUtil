/**
 * CBR_IFC_WS_OUT_LICENCA_SEM_VENSoapBindingStub.java
 *
...
public class CBR_IFC_WS_OUT_LICENCA_SEM_VENSoapBindingStub extends org.apache.axis.client.Stub implements com.meta4.schemas.Cbr_Ifc_Ws_Out_Licenca_Sem_VenService {
    ...
    private static void _initOperationDesc1(){
        ...
        param = new org.apache.axis.description.ParameterDesc(new javax.xml.namespace.QName("", "CBR_IFC_WS_OUT_LICENCA_SEM_VEN"), org.apache.axis.description.ParameterDesc.IN, new javax.xml.namespace.QName("http://schemas.meta4.com/types", "Cbr_Ifc_Ws_Out_Licenca_Sem_VenBlock"), com.meta4.schemas.types.Cbr_Ifc_Ws_Out_Licenca_Sem_VenBlock.class, false, false);
        ...
        oper = new org.apache.axis.description.OperationDesc();
        oper.setName("GET_LICENCA_SEM_VENCIMENTO");
        ...
        oper.addParameter(param);
        param = new org.apache.axis.description.ParameterDesc(new javax.xml.namespace.QName("", "ARG_TIPO_VIGENCIA"), org.apache.axis.description.ParameterDesc.IN, new javax.xml.namespace.QName("http://schemas.xmlsoap.org/soap/encoding/", "string"), java.lang.String.class, false, false);
        oper.addParameter(param);
        oper.setReturnType(new javax.xml.namespace.QName("http://schemas.meta4.com/types", "Get_Licenca_Sem_VencimentoOutput"));
        oper.setReturnClass(com.meta4.schemas.types.Get_Licenca_Sem_VencimentoOutput.class);
        oper.setReturnQName(new javax.xml.namespace.QName("", "GET_LICENCA_SEM_VENCIMENTOReturn"));
        oper.setStyle(org.apache.axis.constants.Style.RPC);
        oper.setUse(org.apache.axis.constants.Use.ENCODED);
        oper.addFault(new org.apache.axis.description.FaultDesc(
                      new javax.xml.namespace.QName("http://schemas.meta4.com/", "fault"),
    ...
    public CBR_IFC_WS_OUT_LICENCA_SEM_VENSoapBindingStub() throws org.apache.axis.AxisFault {
         this(null);
    }

    public CBR_IFC_WS_OUT_LICENCA_SEM_VENSoapBindingStub(java.net.URL endpointURL, javax.xml.rpc.Service service) throws org.apache.axis.AxisFault {
         this(service);
         super.cachedEndpoint = endpointURL;
    }

    public CBR_IFC_WS_OUT_LICENCA_SEM_VENSoapBindingStub(javax.xml.rpc.Service service) throws org.apache.axis.AxisFault {
        if (service == null) {
        ...
        ((org.apache.axis.client.Service)super.service).setTypeMappingVersion("1.2");
            ...
            qName = new javax.xml.namespace.QName("http://schemas.meta4.com/types", "Cbr_Ifc_Ws_Out_Licenca_Sem_VenBlock");
            cachedSerQNames.add(qName);
            cls = com.meta4.schemas.types.Cbr_Ifc_Ws_Out_Licenca_Sem_VenBlock.class;
            cachedSerClasses.add(cls);
            cachedSerFactories.add(beansf);
            cachedDeserFactories.add(beandf);

            qName = new javax.xml.namespace.QName("http://schemas.meta4.com/types", "Cbr_Ifc_Ws_Out_Licenca_Sem_VenRecord");
            cachedSerQNames.add(qName);
            cls = com.meta4.schemas.types.Cbr_Ifc_Ws_Out_Licenca_Sem_VenRecord.class;
            cachedSerClasses.add(cls);
            cachedSerFactories.add(beansf);
            cachedDeserFactories.add(beandf);

            qName = new javax.xml.namespace.QName("http://schemas.meta4.com/types", "Get_Licenca_Sem_VencimentoOutput");
            cachedSerQNames.add(qName);
            cls = com.meta4.schemas.types.Get_Licenca_Sem_VencimentoOutput.class;
            cachedSerClasses.add(cls);
            cachedSerFactories.add(beansf);
            cachedDeserFactories.add(beandf);
            ...
            qName = new javax.xml.namespace.QName("http://schemas.meta4.com/", "ArrayOf_tns1_Cbr_Ifc_Ws_Out_Licenca_Sem_VenRecord");
            cachedSerQNames.add(qName);
            cls = com.meta4.schemas.types.Cbr_Ifc_Ws_Out_Licenca_Sem_VenRecord[].class;
            cachedSerClasses.add(cls);
            qName = new javax.xml.namespace.QName("http://schemas.meta4.com/types", "Cbr_Ifc_Ws_Out_Licenca_Sem_VenRecord");
 ...
 try {        java.lang.Object _resp = _call.invoke(new java.lang.Object[] {CBR_IFC_WS_OUT_LICENCA_SEM_VEN});
  ...
  throw axisFaultException;
    ...
    public com.meta4.schemas.types.Get_Licenca_Sem_VencimentoOutput GET_LICENCA_SEM_VENCIMENTO(java.lang.String ARG_ENTIDADE, java.lang.String ARG_MATRICULA, java.lang.String ARG_TIPO_VIGENCIA) throws java.rmi.RemoteException, com.meta4.soapservices.exception.M4SoapException {
        ...
        _call.setSOAPActionURI("");
        _call.setSOAPVersion(org.apache.axis.soap.SOAPConstants.SOAP11_CONSTANTS);
        _call.setOperationName(new javax.xml.namespace.QName("http://schemas.meta4.com/", "GET_LICENCA_SEM_VENCIMENTO"));

        setRequestHeaders(_call);
        setAttachments(_call);
 try {        java.lang.Object _resp = _call.invoke(new java.lang.Object[] {ARG_ENTIDADE, ARG_MATRICULA, ARG_TIPO_VIGENCIA});
        ...
        if (_resp instanceof java.rmi.RemoteException) {
            ...
            extractAttachments(_call);
            try {
                return (com.meta4.schemas.types.Get_Licenca_Sem_VencimentoOutput) _resp;
            } catch (java.lang.Exception _exception) {
                return (com.meta4.schemas.types.Get_Licenca_Sem_VencimentoOutput) org.apache.axis.utils.JavaUtils.convert(_resp, com.meta4.schemas.types.Get_Licenca_Sem_VencimentoOutput.class);
            }
        }
  } catch (org.apache.axis.AxisFault axisFaultException) {
    if (axisFaultException.detail != null) {
